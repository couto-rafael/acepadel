      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pt-24">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            ...
            className="bg-accent-500 text-dark-900 px-6 py-3 rounded-lg hover:bg-accent-400 flex items-center font-semibold"
          >
        ...
        {filteredTournaments.length === 0 ? (
          <div className="bg-white rounded-lg shadow p-12 text-center">
            ...
            {filter === 'all' && (
              <Link
                to="/create-tournament"
                className="inline-flex items-center bg-accent-500 text-dark-900 px-6 py-3 rounded-lg hover:bg-accent-400 font-semibold"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="flex space-x-2">
                      ...
                      <button className="p-2 text-gray-600 hover:text-accent-600 hover:bg-accent-50 rounded">
                        <Edit2 size={16} />
                      </button>
