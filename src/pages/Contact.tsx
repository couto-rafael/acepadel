          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex items-center justify-center mb-6">
                ...
                <span className="text-accent-500 font-bold text-lg tracking-wide">FALE CONOSCO</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h2 className="text-3xl font-black text-dark-800 mb-6">
                  Vamos jogar juntos?
                </h2>
                <p className="text-dark-600 text-lg leading-relaxed mb-8">
                  Estamos aqui para tornar sua experiência no padel ainda melhor. 
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-dark-500">Segunda a Sexta, 8h às 18h</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-dark-600">contato@acepadel.com.br</p>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                  ...
                  <div>
                    ...
                    <p className="text-dark-600">Av. Paulista, 1000 - Bela Vista</p>
                ...
                <div className="flex items-start space-x-4 p-6 bg-white rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-all">
                  ...
                  <div>
                    <h3 className="font-bold text-dark-800 mb-1">Horário de Atendimento</h3>
            ...
            <div className="bg-white rounded-xl shadow-xl p-8 border border-gray-100">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-black text-dark-800">Envie sua Mensagem</h2>
              </div>
          ...
          <div className="mt-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-bold text-dark-800 mb-3">Como me inscrevo em um torneio?</h3>
                <p className="text-dark-600">
                  É muito simples! Navegue pelos torneios disponíveis, escolha o que mais te interessa 
                  e clique em "Inscrever-se". Você será direcionado para o processo de inscrição.
                </p>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-bold text-dark-800 mb-3">Como posso cadastrar meu clube?</h3>
                <p className="text-dark-600">
                  Clique em "Entrar" e selecione "Clube" no tipo de conta. Preencha os dados do seu 
                  clube e comece a criar torneios incríveis!
                </p>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-bold text-dark-800 mb-3">Posso cancelar minha inscrição?</h3>
                <p className="text-dark-600">
                  Sim! Você pode cancelar sua inscrição até 48 horas antes do início do torneio. 
                  Acesse seu dashboard para gerenciar suas inscrições.
                </p>
              </div>

              <div className="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                <h3 className="font-bold text-dark-800 mb-3">Como funciona o sistema de ranking?</h3>
                <p className="text-dark-600">
                  Nosso ranking é baseado na sua performance nos torneios. Quanto mais você joga 
                  e melhor seu desempenho, maior sua posição no ranking!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                ...
                Conecte-se, jogue e evolua no esporte que mais cresce no país.
              </p>
