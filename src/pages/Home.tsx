    ...
    <div className="min-h-screen bg-light">
      ...
      <div id="tournaments-section" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="mb-8 text-center">
          <h2 className="text-3xl font-black text-dark-800 mb-4">Próximos Duelos</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Torneios</a></li>
