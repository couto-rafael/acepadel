              ...
              <div className="overflow-y-auto h-[calc(100%-73px)]">
                {chats.map(chat => (
                  ...
                  >
                    <div className="relative">
                      ...
                      <span
                        className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${
                          chat.user.status === 'online' ? 'bg-accent-500' : 'bg-gray-400'
                        }`}
                      />
                    </div>
                    ...
                    {chat.unread > 0 && (
                      <span className="bg-accent-500 text-dark-900 text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
                        {chat.unread}
                      </span>
                    )}
                  </button>
                  ...
                  <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {messages.map(message => (
                      ...
                      >
                        ...
                        >
                          <p>{message.content}</p>
                          <span className={`text-xs ${message.isMe ? 'text-dark-700' : 'text-gray-500'} block mt-1`}>
                            {message.timestamp}
                          </span>
                        </div>
                      </div>
