            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex flex-col items-center">
                ...
                <div className="flex items-center space-x-4 mt-4">
                  ...
                  <button className="text-gray-600 hover:text-accent-500">
                    <Share2 size={20} />
                  </button>
                </div>
                ...
                <div className="w-full mt-6">
                  ...
                  <div className="flex flex-wrap gap-2">
                    <span className="bg-accent-100 text-accent-800 px-2 py-1 rounded-full text-sm">
                      Padel
                    </span>
                  </div>
                </div>
              ...
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="relative" ref={addMenuRef}>
                  <button
                    ...
                    className="bg-accent-500 text-dark-900 p-2 rounded-full hover:bg-accent-400"
                  >
                    <Plus size={20} />
                  </button>
                  {isAddMenuOpen && (
              ...
              <div className="space-y-4">
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex items-start">
                    <Calendar size={28} className="text-accent-500 mt-1 mr-4" />
                    <div>
                      ...
                      <button className="bg-accent-500 text-dark-900 px-6 py-2 rounded-md hover:bg-accent-400 transition duration-300 flex items-center font-semibold">
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex items-start">
                    <Users size={28} className="text-accent-500 mt-1 mr-4" />
                    <div>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <div className="flex items-start">
                    <Settings size={28} className="text-accent-500 mt-1 mr-4" />
                    <div>
                      ...
                      <Link
                        to="/settings"
                        className="bg-accent-500 text-dark-900 px-6 py-2 rounded-md hover:bg-accent-400 transition duration-300 flex items-center inline-flex font-semibold"
                      >
            ...
            <div className="space-y-4">
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center">
                    <Trophy size={20} className="text-accent-500 mr-2" />
              ...
              <div className="bg-white rounded-lg shadow p-6">
                <div className="flex items-center mb-3">
                  <UserPlus size={20} className="text-accent-500 mr-2" />
                  <h3 className="font-semibold">Encontre Amigos/Atletas</h3>
                </div>
                <p className="text-gray-600 text-sm mb-3">
                  Conecte-se com outros jogadores e expanda sua rede no esporte.
                </p>
                <Link to="/find-athletes" className="text-accent-500 hover:text-accent-600 text-sm font-medium">
                  Encontre aqui
                </Link>
              </div>
            </div>
      ...
      <footer className="bg-gradient-to-br from-dark-900 via-primary-900 to-dark-900 text-white py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">AcePadel</h3>
              <p className="text-gray-300 mb-4">
                A melhor plataforma para encontrar e participar de torneios de padel no Brasil.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="text-white hover:text-accent-500">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-300 hover:text-white">Torneios</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">Rankings</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">Clubes</a></li>
