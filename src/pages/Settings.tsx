        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-end space-x-2 mt-6">
            ...
            <button
              ...
              className="px-4 py-2 bg-accent-500 text-dark-900 rounded-md hover:bg-accent-400 font-semibold"
            >
              Salvar
            </button>
          </div>
        ...
        {isEditing ? (
          <div className="flex items-center">
            <input
              ...
              className="block w-full px-3 py-2 border border-accent-300 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-500"
              autoFocus
            />
            <button
              ...
              className="absolute right-3 text-accent-600 hover:text-accent-700"
            >
              <Check size={16} />
            </button>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="pt-4">
          <button
            ...
            className="w-full bg-accent-500 text-dark-900 py-2 rounded-md hover:bg-accent-400 font-semibold"
          >
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div className={`p-2 rounded-full ${
                      achievement.earned ? 'bg-accent-200' : 'bg-gray-200'
                    }`}>
                      <achievement.icon
                        size={24}
                        className={achievement.earned ? 'text-accent-600' : 'text-gray-500'}
                      />
                    </div>
                    <div>
                ...
                {performanceStats.recentMatches.map(match => (
                  <div
                    ...
                    className={`flex items-center justify-between p-3 rounded-lg ${
                      match.result === 'win' ? 'bg-accent-50' : 'bg-red-50'
                    }`}
                  >
                    <div>
                      <span className={`font-medium ${
                        match.result === 'win' ? 'text-accent-600' : 'text-red-600'
                      }`}>
                    ...
                    <button
                      ...
                      className={`w-full text-left px-4 py-3 flex items-center space-x-3 ${
                        selectedSection === item.id
                          ? 'bg-accent-50 border-l-4 border-accent-600 text-accent-700'
